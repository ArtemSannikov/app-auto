	...
	function changeBackground(){
		...
		switch(optionBackground){
			case 'white_background':
				...
				$('.ui-page-theme-a, .ui-panel-wrapper *, .ui-content>.ui-listview>li>a.ui-btn').css('background-color', white_bgc);
			break;
			case 'gray_background':
				localStorage.setItem('backgroundColor_key','#ecf0f1');
				$('.ui-page-theme-a, .ui-panel-wrapper *, .ui-content>.ui-listview>li>a.ui-btn').css('background-color', gray_bgc);
			break;
			case 'black_background':
				localStorage.setItem('backgroundColor_key','#2f3640');
				$('.ui-page-theme-a, .ui-panel-wrapper *, .ui-content>.ui-listview>li>a.ui-btn').css('background-color', black_bgc);
			break;
		}
	...
	window.onload = function(){
		...
		if(localStorage.getItem('backgroundColor_key') !== null){
			...
			$('.ui-page-theme-a, .ui-panel-wrapper *, .ui-content>.ui-listview>li>a.ui-btn').css('background-color', backgroundPage);
		}
